  ...
  <div v-if="service" class="p-6 max-w-7xl mx-auto font-sans bg-gray-50/50 min-h-screen rounded-3xl page-enter-anim">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      <div class="lg:col-span-2 bg-white rounded-3xl p-8 border border-gray-100 shadow-sm">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Présentation</h3>
        <p class="text-gray-600 leading-relaxed">
          {{ service.description }}
        </p>

        <h3 class="text-lg font-semibold text-gray-900 mt-8 mb-4">Caractéristiques</h3>
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div
            v-for="feature in service.caracteristiques"
            :key="feature"
            class="flex items-center gap-3 p-3 rounded-xl border border-gray-100 bg-gray-50/60"
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5 text-gray-900 shrink-0">
      ...
      <div class="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm h-fit space-y-6">
        <h3 class="text-lg font-semibold text-gray-900">Informations pratiques</h3>
        ...
        <div class="flex items-start gap-3">
          ...
          <div>
            <p class="text-xs uppercase tracking-wider text-gray-400">Horaires</p>
            <p class="mt-1 font-medium text-gray-800">{{ service.horaires }}</p>
          </div>
        </div>
        ...
        <div class="flex items-start gap-3">
          ...
          <div>
            <p class="text-xs uppercase tracking-wider text-gray-400">Tarif / Capacité</p>
            <p class="mt-1 font-medium text-gray-800">{{ service.info }}</p>
          </div>
        </div>
      </div>
    </div>

<template>
  ...
  >
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
      <div
        class="bg-white rounded-3xl p-8 border border-sand-200 hover:border-sand-300 hover:shadow-xl transition-all duration-300"
      >
        <div class="flex flex-col items-center">
          <div
            class="w-28 h-28 rounded-full bg-navy-500 flex items-center justify-center text-white text-5xl font-semibold shadow-lg"
          >
            {{ reservation.name.charAt(0) }}
          </div>

          <h2 class="mt-6 text-2xl font-semibold text-navy-500">
            {{ reservation.name }}
          </h2>

          <p class="mt-3 text-sm text-navy-300">Client enregistré</p>
        </div>

        <div class="mt-10 space-y-6">
          <div class="group border-b pb-4 hover:pl-2 transition-all duration-300">
            <p class="flex items-center gap-1.5 text-xs uppercase tracking-wider text-navy-200">
              <Icon name="phone" class="w-3.5 h-3.5" />
              Téléphone
            </p>

            <p class="mt-1 font-medium text-navy-500">
              {{ reservation.phone }}
            </p>
          </div>
      ...
      <div
        class="xl:col-span-2 bg-white rounded-3xl p-8 border border-sand-200 hover:shadow-xl transition-all duration-300"
      >
        <h2 class="text-2xl font-semibold text-navy-500 mb-10">Informations du séjour</h2>

        <div class="grid md:grid-cols-2 gap-6">
          <div
            class="p-6 rounded-2xl border border-sand-200 hover:border-sand-300 hover:shadow-md transition-all duration-300"
          >
            <p class="flex items-center gap-1.5 text-xs uppercase tracking-wider text-navy-200">
            ...
            <p class="mt-3 font-semibold text-navy-500 text-lg">
              {{ reservation.type }}
            </p>
          </div>
          ...
          >
            ...
            <p class="mt-3 font-semibold text-navy-500 text-lg">{{ numberOfDays }} jours</p>
          </div>
        </div>

        <div class="mt-10">
          <h3 class="text-xl font-semibold text-navy-500 mb-4">Suivi du séjour</h3>
        ...
        <div class="mt-10">
          <h3 class="text-xl font-semibold text-navy-500 mb-4">Observations</h3>

          <textarea
            rows="6"
            class="w-full rounded-2xl border border-sand-200 p-5 text-sm text-navy-400 placeholder:text-navy-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-navy-500 focus:border-navy-500 transition-colors duration-200 resize-none"

<template>
  <button
    :type="type"
    class="inline-flex items-center justify-center gap-2 rounded-xl font-medium transition cursor-pointer whitespace-nowrap disabled:opacity-50 disabled:cursor-not-allowed"
...
const sizeClasses = computed(() => {
  return props.size === 'sm' ? 'px-4 py-2 text-sm' : 'px-5 py-2.5 text-sm'
})
